...
abstract class AbstractRemoveExtensionsTest<T> extends PlatformAwareTestBase {
    ...
    void removeSomeValidExtensions() throws Exception {
        ...
        final QuarkusCommandOutcome result = removeExtensions(
                asList("jdbc-postgre", "agroal", "quarkus-arc", " hibernate-validator",
    ...
    void testPartialMatches() throws Exception {
        ...
        final QuarkusCommandOutcome result = removeExtensions(asList("jdbc-postgre", "hibernate-orm", "arc"));
    ...
    void testRegexpMatches() throws Exception {
        ...
        final QuarkusCommandOutcome result = removeExtensions(Collections.singletonList("Sm??lRye**"));
    ...
    void removeExtensionTwiceInOneBatch() throws Exception {
        ...
        final QuarkusCommandOutcome result = removeExtensions(asList("agroal", "agroal"));
        project = readProject();
        doesNotHaveDependency(project, "quarkus-agroal");
        Assertions.assertTrue(result.isSuccess());
        Assertions.assertTrue(result.valueIs(RemoveExtensions.OUTCOME_UPDATED, true));
    ...
    void removeExtensionTwiceInTwoBatches() throws Exception {
        createProject();
        final T project0 = readProject();
        hasDependency(project0, "quarkus-agroal");
    ...
    void testPartialMatchConflict() throws Exception {
        createProject();
        final T project0 = readProject();
        hasDependency(project0, "quarkus-arc");
        ...
        Assertions.assertTrue(result.isSuccess());
        final T project1 = readProject();
        doesNotHaveDependency(project1, "quarkus-arc");
        hasDependency(project0, "quarkus-hibernate-search-elasticsearch");
    ...
    void removeExistingAndMissingExtensions() throws Exception {
        ...
        final T project0 = readProject();
        hasDependency(project0, "quarkus-arc");
        doesNotHaveDependency(project0, "quarkus-missing");
    ...
    void removeDuplicatedExtensionUsingGAV() throws Exception {
        createProject();
        final T project0 = readProject();
        hasDependency(project0, "commons-io", "commons-io", "2.6");

        final QuarkusCommandOutcome result = removeExtensions(asList("commons-io:commons-io:2.6", "commons-io:commons-io:2.6"));

        final T project1 = readProject();
        doesNotHaveDependency(project1, "commons-io", "commons-io", "2.6");
        Assertions.assertTrue(result.isSuccess());
        Assertions.assertTrue(result.valueIs(RemoveExtensions.OUTCOME_UPDATED, true));
    }
    ...
    void testVertx() throws Exception {
        createProject();
        final T project0 = readProject();
        hasDependency(project0, "quarkus-vertx");

        final QuarkusCommandOutcome result = removeExtensions(Collections.singletonList("vertx"));

        final T project1 = readProject();
        doesNotHaveDependency(project1, "quarkus-vertx");
        Assertions.assertTrue(result.isSuccess());
        Assertions.assertTrue(result.valueIs(RemoveExtensions.OUTCOME_UPDATED, true));
    }
    ...
    void testVertxWithDot() throws Exception {
        ...
        final QuarkusCommandOutcome result = removeExtensions(Collections.singletonList("vert.x"));
    ...
    private void doesNotHaveDependency(T project, String artifactId) {
        doesNotHaveDependency(project, getPluginGroupId(), artifactId, null);
    }

    private void doesNotHaveDependency(T project, String groupId, String artifactId, String version) {
        Assertions.assertTrue(countDependencyOccurrences(project, groupId, artifactId, version) == 0);
    }
